...
> **Wichtig:** Die Eingabe akzeptiert sowohl Ganzzahlen (`2`) als auch Dezimalwerte mit Punkt (`.`) wie `1.3`. Eingaben mit Dezimalkomma (`1,3`) werden hingegen verworfen und lösen automatisch den dokumentierten Fallback auf den Standardwert aus.
